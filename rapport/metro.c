...
metro creerMetro(){
	...
	*(station50->correspondance+3) = station166;
	...
	*(station61->correspondance+1) = station62;
	...
	*(station121->correspondance+2) = station166;
